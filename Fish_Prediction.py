...
st.set_page_config(page_title='Fish Identify', page_icon=':fish:', layout='centered')
    
def main():
    st.sidebar.title('Fish Identify')
    menu = ['Home', 'About Us']
...
if uploaded_file is not None:
    ...
    #st.write(f"The predicted fish species is: {class_labels[pred[0]]}")
    st.write(f'Top predicted class: {class_labels[pred[0]]} (confidence: {confidence_score:.2f})')
